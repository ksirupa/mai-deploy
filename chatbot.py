...
class Chatbot:
    prompt = """You are a helpful life assistant. Your name is Wall-E! Be polite and friendly. Use the memory provided to provide a
    ...
    def __call__(self, user_message):
      ...
      return "My name:"+ai_message.content + "\n" + "Kiran Sirupa's Tokens used: " + str(ai_message.response_metadata["token_usage"]["total_tokens"])
